...
<section class="konten my-5 p-2"  >
    <div class="container p-5">
        ...
        <div class="container bg-light p-2 my-3" >
            <h5>Nama Admin : <?= $_SESSION['admin']['fullname'];?></h5>
            <p>Tanggal : <?= date("d F Y", strtotime($pecah_akun['waktu_admin']));?></p>
            <div class="input-group" >  
                <textarea readonly class="form-control text-dark" rows="1"><?= $pecah_akun['pesan_admin'];?></textarea>
...
if(isset($_POST['balas'])){
    $chat = $_POST['chat'];
        ...
        $pesan_admin = $pecah_akun['pesan_admin'];
        $connect->query("INSERT INTO chat (id_chat_user, id_enroll, id_message, id_pelanggan, pesan_user, pesan_admin) VALUES ('','$id_barusan', '$id', '$id_pelanggan', '$chat', '$pesan_admin')");
