    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="nota.php?id=<?= $value['id_pembelian'];?>" class="btn btn-info text-white">Nota</a>
                    <?php if(empty($value['resi_pengiriman']) and $value['status_pembelian'] == 'pending'):?>
                    <a href="pembayaran.php?id=<?= $value['id_pembelian']; ?>" class="btn btn-success">Input pembayaran</a>
                    <a href="batalkanpembayaran.php?id=<?= $pecah['id_pembelian'];?>" class="btn btn-danger">Batalkan</a>
                    <?php else :?>
